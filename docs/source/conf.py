...
htmlhelp_basename = 'COBRAToolboxDoc'
...
latex_documents = [
    (master_doc, 'TheCOBRAToolbox.tex', u'The COBRAToolbox Documentation',
     u'The COBRAToolbox developers', 'manual'),
]
...
man_pages = [
    (master_doc, 'cobratoolbox', u'The COBRAToolbox Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TheCOBRAToolbox', u'The COBRAToolbox Documentation',
     author, 'TheCOBRAToolbox', 'One line description of project.',
     'Miscellaneous'),
]
